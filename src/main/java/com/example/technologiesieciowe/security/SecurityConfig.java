                ...
                .authorizeHttpRequests(
                        authorizationManagerRequestMatcherRegistry ->
                                authorizationManagerRequestMatcherRegistry
                                        ...
                                        .requestMatchers("/user/getAll").hasAnyRole("ADMIN", "LIBRARIAN")
                                        .requestMatchers("/user/getOne/{id}").hasAnyRole("ADMIN", "LIBRARIAN", "USER")
                                        .requestMatchers("/user/getUserId").hasAnyRole("ADMIN", "LIBRARIAN", "USER")
